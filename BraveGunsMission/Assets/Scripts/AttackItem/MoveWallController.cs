...
public class MoveWallController : MonoBehaviour
{
    ...
    public float wallspeed = 6.0f;     //   動く壁の移動速度
    public int wallpower = 5;    //  動く壁の攻撃力
    ...
    {
        //  X方向に移動する
        this.transform.position += new Vector3(1, 0, 0) * wallspeed * Time.deltaTime;
    }
    ...
    void OnCollisionStay(Collision other)
    {
        ...
        if(other.gameObject.tag == "Player")
        {
            ...
            {
                //  プレイヤーのダメージ処理を呼び出す
                playerHPController.Damage(wallpower);
            }
        }
    }
}
